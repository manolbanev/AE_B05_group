...
def get_shear(dist: np.array) -> sp.interpolate.interpolate.interp1d:
    """
...
def calculate_margin(dist: np.array, load_func: any, failure_func: any) -> sp.interpolate.interpolate.interp1d:
    """
